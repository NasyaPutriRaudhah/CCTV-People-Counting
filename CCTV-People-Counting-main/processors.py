...
def process_video2_line(frame, model, timer, line_tracker, data_persistence, 
    ...
    line_y_scaled = int(line_enter_y * scale_y)   # gunakan 1 nilai saja
    cv2.line(frame, (line_x1_scaled, line_y_scaled), (line_x2_scaled, line_y_scaled),
            (0, 255, 255), 3)
    cv2.putText(frame, "CROSSING LINE (down=+1 | up=-1)",
                (line_x1_scaled, line_y_scaled - 10),
